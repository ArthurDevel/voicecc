...
Your working directory is `<<AGENT_DIR>>`. All your files live here.
...
**IMPORTANT: Only read and write files inside your own directory (`<<AGENT_DIR>>`). Never access files belonging to other agents.**
